...
public class TsunamiService {
    ...
    private final TsunamiDataImporter rawImporter = new TsunamiDataImporter(new TsunamiRawParser());
    private final TsunamiDataImporter cleanImporter = new TsunamiDataImporter(new TsunamiCleanParser());
