...
public class VolcanoService {
    ...
    private final VolcanoDataImporter rawImporter = new VolcanoDataImporter(new VolcanoRawParser());

    // clean 파서로 정제된 csv 데이터를 다시 로드
    private final VolcanoDataImporter cleanImporter = new VolcanoDataImporter(new VolcanoCleanParser());
